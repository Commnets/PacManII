...
{  
	...
	addActionBlock (new PacManII::MonsterSceneActionBlock 
		(0, PacManII::MonsterSceneActionBlock::Properties (__PACMANII_BLINKYBASEENTITYID__, PacManII::Blinky::_NUMBER, 100)), false);
	addActionBlock (new PacManII::MonsterSceneActionBlock 
		(1, PacManII::MonsterSceneActionBlock::Properties (__PACMANII_PINKYBASEENTITYID__, PacManII::Pinky::_NUMBER, 100)), false);
	addActionBlock (new PacManII::MonsterSceneActionBlock 
		(2, PacManII::MonsterSceneActionBlock::Properties (__PACMANII_INKYBASEENTITYID__, PacManII::Inky::_NUMBER, 100)), false);
	addActionBlock (new PacManII::MonsterSceneActionBlock 
