...
// ---
void PacManII::GUISystem::drawOn (QGAMES::Screen* s, const QGAMES::Position& p)
{
...
// ---
PacManII::WhenFocusDecorator::WhenFocusDecorator ()
...
// ---
void PacManII::ControlWidget::processEvent (const QGAMES::Event& e)
{
	if (e.code () == __QGAMES_WIDGETGETFOCUSEVENT__)
		((QGAMES::Widget*) e.data ()) -> setDecorator (new PacManII::WhenFocusDecorator ());
	else
